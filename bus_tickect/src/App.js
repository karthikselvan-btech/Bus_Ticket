...
function App() {
  ...
  return (
    <div className="App">
      <Router>
        <Navbar loggedin={window.localStorage.getItem("user")}></Navbar>
        <Routes>
          <Route
            exact
            path="/"
            element={<Homepage loggedin={loggedin}></Homepage>}
          ></Route>
          ...
          <Route
            exact
            path="/getbuses"
            element={<Getallbuses></Getallbuses>}
          ></Route>
          <Route
            exact
            path="/findbuses"
            element={<FindBuses></FindBuses>}
          ></Route>
          ...
          <Route
            ...
            path="/getuserdetails"
            element={
              <Getuserdetails loggedinuser={loggedinuser}></Getuserdetails>
            }
          ></Route>
          <Route
            exact
            path="/addpassengers"
            element={<Addpassenger loggedinuser={loggedinuser}></Addpassenger>}
          ></Route>
          <Route
            exact
            path="/cancelt"
            element={<Canceltickets></Canceltickets>}
          ></Route>
          <Route
            exact
            path="/makepayment"
