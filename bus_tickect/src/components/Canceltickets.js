...
export default function Canceltickets() {
  ...
  const submithandler = async (e) => {
    ...
    await axios
      .get("http://localhost:8090/getpassengers")
  ...
  const submithandler2 = async (e) => {
    ...
    const result = await axios
      .put(`http://localhost:8090/canceled/${pnr_details}`)
            ...
            <form onSubmit={(e) => submithandler(e)}>
              <div className="mb-3">
                ...
                <input
                  ...
                  name="pnr"
                  onChange={(e) => setpnr_details(e.target.value)}
                ></input>
              </div>
          ...
          <table className="table border shadow t2">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <h4>{details.aadhar}</h4>
                </td>

                <td>
                  <h4>{details.booking}</h4>
                </td>
              </tr>
            </tbody>
          </table>
